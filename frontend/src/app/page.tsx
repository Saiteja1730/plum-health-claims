    ...
    try {
      ...
      if (fileToUpload) {
        ...
        const mappedData: ClaimFormState = {
          member_id: "EMP001",
          member_name: extracted.member_name || extracted.document_patient_name || "Unknown",
          member_age: extracted.member_age || 30,
          treatment_date: extracted.treatment_date || "2026-06-01",
          claim_amount: Number(extracted.claim_amount) || 1500,
          diagnosis: extracted.diagnosis || "Acute Gastritis",
          treatment_type: extracted.treatment_type || "consultation",
          doctor_name: extracted.doctor_name || "Dr. A. K. Sharma",
          doctor_registration: extracted.doctor_registration || "DL/12345/2018",
          hospital_name: extracted.hospital_name || "Max Healthcare",
          prescription_uploaded: extracted.prescription_present ?? true,
          bill_uploaded: extracted.bill_present ?? true,
          report_uploaded: extracted.report_present ?? false,
          document_patient_name: extracted.document_patient_name || extracted.member_name || "Rajesh Kumar",
          prescription_date: extracted.prescription_date || "01/06/2026",
          bill_date: extracted.bill_date || "01/06/2026",
          ...
          member_join_date: "01/01/2025",
          claim_submission_date: "04/06/2026",
          procedures: extracted.procedures || "OPD Consultation",
        };
